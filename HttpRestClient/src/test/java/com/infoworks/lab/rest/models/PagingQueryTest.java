...
public class PagingQueryTest {
    ...
    public void testConstruction() throws IOException {
        String json = "{\"offset\":0,\"size\":10,\"previousOffset\":0,\"descriptors\":[{\"order\":\"ASE\",\"keys\":[\"name\"]},{\"order\":\"DESC\",\"keys\":[\"age\",\"salary\"]}]}";
        //String json = "{\"offset\":0,\"size\":0,\"previousOffset\":0,\"descriptors\":[{\"order\":\"ASE\",\"keys\":null}]}";
