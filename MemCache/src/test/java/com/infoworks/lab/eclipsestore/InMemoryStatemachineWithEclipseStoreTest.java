...
public class InMemoryStatemachineWithEclipseStoreTest {

    String location = "target/EclipseStore/InMemoryStatemachineTest";
    PizzaService service;

    @Before
    public void before() {
        service = new PizzaService(location
                , new EclipseDataStore(location + "/statemachine")
                , new EclipseDataStore(location + "/pizza"));
